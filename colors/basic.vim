...
highlight CursorLineNr ctermfg=14 ctermbg=235 cterm=NONE guifg=#84898c guibg=#2a343a gui=NONE
highlight CursorColumn ctermfg=NONE ctermbg=23 cterm=NONE guifg=NONE guibg=#2e373b gui=NONE
highlight ColorColumn ctermfg=NONE ctermbg=234 cterm=NONE guifg=NONE guibg=#2e373b gui=NONE
highlight LineNr ctermfg=14 ctermbg=240 cterm=NONE guifg=#84898c guibg=#2a343a gui=NONE
...
highlight StatusLine ctermfg=231 ctermbg=59 cterm=bold guifg=#f0f0f0 guibg=#575e61 gui=bold
highlight StatusLineNC ctermfg=231 ctermbg=59 cterm=NONE guifg=#f0f0f0 guibg=#575e61 gui=NONE
...
highlight NonText ctermfg=59 ctermbg=16 cterm=NONE guifg=#414e58 guibg=#232c31 gui=NONE
